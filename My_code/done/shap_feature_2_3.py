...
selected_features = ['X559_log_x_x_stat_median', 'X34_log_x_buy_qty', 'X41_log_x_volume', 'X466_log_x_sell_qty', 'X752', 'X614_log_x_x_stat_median', 'X609', 'X86_log_x_x_stat_mean', 'X41', 'X681_log_x_x_stat_mean', 'X34_log_x_volume', 'X563', 'X55', 'X737_log_x_volume', 'X137_log_x_x_stat_mean', 'X609_log_x_sell_qty', 'X586_log_x_buy_qty', 'X582_log_x_sell_qty', 'X306_log_x_buy_qty', 'X21', 'X557_log_x_sell_qty', 'X302_log_x_x_stat_mean', 'X741_log_x_sell_qty', 'X702_log_x_x_stat_median', 'X170_log_x_sell_qty', 'X301_log_x_x_stat_mean', 'X758', 'X144_log_x_x_stat_median', 'X738_log_x_x_stat_mean', 'X17_log_x_x_stat_mean', 'X615_log_x_x_stat_mean', 'X6_log_x_buy_qty', 'X4_log_x_buy_qty', 'X660_log_x_sell_qty', 'X681_log_x_sell_qty', 'X586_log_x_sell_qty', 'X570_log_x_volume', 'X299_log_x_x_stat_mean', 'X725_log_x_volume', 'X55_log_x_buy_qty', 'X214_log_x_x_stat_mean', 'X192_log_x_sell_qty', 'X516_log_x_sell_qty', 'X517_log_x_x_stat_mean', 'X183_log_x_buy_qty', 'X563_log_x_x_stat_median', 'X41_log_x_x_stat_median', 'X540', 'X558_log_x_x_stat_median', 'X452', 'X776_log_x_x_stat_mean', 'X199_log_x_buy_qty', 'X540_log_x_x_stat_mean', 'X603_log_x_x_stat_mean', 'X436_log_x_x_stat_median', 'X582_log_x_x_stat_mean', 'X611', 'X699_log_x_sell_qty', 'X312_log_x_volume', 'X265_log_x_x_stat_mean', 'X518_log_x_x_stat_median', 'X567_log_x_sell_qty', 'X421_log_x_volume', 'X474', 'X348_log_x_x_stat_mean', 'X700_log_x_volume', 'X576', 'X758_log_x_volume', 'X41_log_x_buy_qty', 'X298_log_x_buy_qty', 'X638_log_x_volume', 'X130_log_x_buy_qty', 'X317_log_x_volume', 'X529_log_x_x_stat_mean', 'X536_log_x_sell_qty', 'X317', 'X217', 'X519_log_x_buy_qty', 'X55_log_x_sell_qty', 'X518_log_x_x_stat_mean']
...
for fold, (train_idx, val_idx) in enumerate(kf.split(X)):
    ...
    tabnet_params = dict(
    n_d=64, n_a=64, n_steps=32, gamma=1.5,
    lambda_sparse=1e-3, mask_type='sparsemax',
    optimizer_fn=torch.optim.AdamW,
    optimizer_params=dict(lr=1e-2, weight_decay=1e-5),
    scheduler_params=dict(step_size=50, gamma=0.9),
...
submission.to_csv("submission_shap_feature_2_3.csv", index=False)
print("Submission file saved as 'submission_shap_feature_2_3.csv'")
