...
selected_features, importance_df = select_top_k_features_by_shap(X_train, y_train, feature_names, k=100)
...
for fold, (train_idx, val_idx) in enumerate(kf.split(X)):
    ...
    perm = np.random.RandomState(37).permutation(len(X_tr))
    X_tr, y_tr = X_tr[perm], y_tr[perm]  # shuffle
...
submission.to_csv("submission_shap_feature_4.csv", index=False)
print("Submission file saved as 'submission_shap_feature_4.csv'")
